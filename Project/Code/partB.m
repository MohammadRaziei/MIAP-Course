...
BDS = binary_dice_loss(img3d_true, img3d_pred);
DS = dice_loss(img3d_true, img3d_pred);
BJS = binary_jaccard_loss(img3d_true, img3d_pred);
JS = jaccard_loss(img3d_true, img3d_pred);
...
ASD = AverageSurfaceDist(ptCloud_true, ptCloud_pred);
